    ...
    <SectionWrapper id="contact" containerSize="md">
      <FadeIn className="text-center flex flex-col items-center">
        ...
        <p className="mt-4 text-base text-muted leading-relaxed max-w-md">
          Open to frontend and product-oriented roles involving dashboards,
          modern web apps, and data-heavy interfaces.
        </p>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
          {CONTACT_LINKS.map((link) => (
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-md text-sm font-medium transition-all duration-200 border border-border hover:border-accent/30 hover:bg-accent/[0.04] hover:text-accent text-muted"
            >
              {link.icon}
              {link.label}
            </a>
